...
export function setupSwagger(app: INestApplication) {
  ...
  SwaggerModule.setup('api-docs', app, document, {
    jsonDocumentUrl: 'swagger.json', // Accessible via http://localhost:3333/api-docs/swagger.json
    yamlDocumentUrl: 'swagger.yaml', // Accessible via http://localhost:3333/api-docs/swagger.yaml
  });
}
